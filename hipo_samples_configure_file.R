...
# counts.sparse.matrix.name <- "sc.10x.counts_K43R-ZPMZFJ-T1N1.RData"
...
# counts.sparse.matrix.name <- "sc.10x.counts_K43R-8YGUU8-T2Z2.RData"
...
# counts.sparse.matrix.name <- "sc.10x.counts_K43R-8YGUU8-T3Z3.RData"
...
# K43R-8YGUU8-(T2;T3;T4) vs ZPMZFJ-N1
# cellranger_outs_folder_positive <- c("/icgc/dkfzlsdf/analysis/hipo2/hipo_K43R/cellranger_results_v3/K43R-8YGUU8-T2/outs/",
#                                      "/icgc/dkfzlsdf/analysis/hipo2/hipo_K43R/cellranger_results_v3/K43R-8YGUU8-T3/outs/",
#                                      "/icgc/dkfzlsdf/analysis/hipo2/hipo_K43R/cellranger_results_v3/K43R-8YGUU8-T4/outs/")
# cellranger_outs_folder_negative <- "/icgc/dkfzlsdf/analysis/hipo2/hipo_K43R/cellranger_results_v3/K43R-ZPMZFJ-N1/outs/"
# cell.annotation.name <- "cellAnnotations_K43R-K43R-8YGUU8-T2T3T4_ZPMZFJ-N1.txt"
# counts.sparse.matrix.name <- "sc.10x.counts_K43R-K43R-8YGUU8-T2T3T4_ZPMZFJ-N1.RData"
